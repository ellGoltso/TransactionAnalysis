from src.utils import get_greetings, get_general_information, get_data_from_excel_file, get_top_five_transactions
...
from tests.conftest import fixture_df_data


@pytest.mark.parametrize("x, expected", [(datetime.datetime(2025, 7, 1, 7, 30, 0), 'Доброе утро'),
